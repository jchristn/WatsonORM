...
namespace Test.PostgresqlAsync
{
    class Program
    {
        ...
        static async Task Main(string[] args)
        {
            try
            {
                ...
                _Settings = new DatabaseSettings(DbTypeEnum.Postgresql, "localhost", 5432, _Username, _Password, "test");
                ...
                p1 = await _Orm.InsertAsync<Person>(p1);

                for (int i = 0; i < 8; i++) Console.WriteLine("");
                Console.WriteLine("| Creating p2");
                p2 = await _Orm.InsertAsync<Person>(p2);

                for (int i = 0; i < 8; i++) Console.WriteLine("");
                Console.WriteLine("| Creating p3");
                p3 = await _Orm.InsertAsync<Person>(p3);

                for (int i = 0; i < 8; i++) Console.WriteLine("");
                Console.WriteLine("| Creating p4");
                p4 = await _Orm.InsertAsync<Person>(p4);
                ...
                await _Orm.InsertMultipleAsync<Person>(people);
                ...
                p9 = await _Orm.InsertAsync<Person>(p9);
                ...
                Console.WriteLine("| Checking existence of records: " + await _Orm.ExistsAsync<Person>(existsExpression));
                ...
                for (int i = 0; i < 8; i++) Console.WriteLine("");
                Console.WriteLine("| Checking sum of ages: " + await _Orm.SumAsync<Person>(_Orm.GetColumnName<Person>(nameof(Person.Age)), existsExpression));
                ...
                List<Person> all = await _Orm.SelectManyAsync<Person>();
                ...
                Person selected1 = await _Orm.SelectFirstAsync<Person>(eSelectGuid);
                ...
                List<Person> selectedList1 = await _Orm.SelectManyAsync<Person>(null, null, eSelect1);
                ...
                Expr eSelect2 = new Expr(
                    ...
                    OperatorEnum.Equals,
                    "Abraham");
                List<Person> selectedList2 = await _Orm.SelectManyAsync<Person>(null, null, eSelect2);
                ...
                Person pSelected = await _Orm.SelectByPrimaryKeyAsync<Person>(3);
                ...
                pSelected = await _Orm.SelectFirstAsync<Person>(eSelect3);
                Console.WriteLine("| Selected: " + pSelected.ToString());
                ...
                await _Orm.UpdateManyAsync<Person>(eSelect1, updateVals);
                ...
                selectedList1 = await _Orm.SelectManyAsync<Person>(null, null, eSelect1);
                Console.WriteLine("| Retrieved: " + selectedList1.Count + " records");
                foreach (Person curr in selectedList1) Console.WriteLine(curr.ToString());

                for (int i = 0; i < 8; i++) Console.WriteLine("");
                Console.WriteLine("| Selecting by ID");
                pSelected = await _Orm.SelectByPrimaryKeyAsync<Person>(3);
                Console.WriteLine("| Selected: " + pSelected.ToString());

                for (int i = 0; i < 8; i++) Console.WriteLine("");
                Console.WriteLine("| Selecting first");
                pSelected = await _Orm.SelectFirstAsync<Person>(eSelect2);
                Console.WriteLine("| Selected: " + pSelected.ToString());

                for (int i = 0; i < 8; i++) Console.WriteLine("");
                Console.WriteLine("| Selecting between, test 1");
                Expr eSelect4 = Expr.Between("id", new List<object> { 2, 4 });
                selectedList1 = await _Orm.SelectManyAsync<Person>(null, null, eSelect4);
                Console.WriteLine("| Retrieved: " + selectedList1.Count + " records");
                foreach (Person curr in selectedList1) Console.WriteLine(curr.ToString());
                ...
                selectedList1 = await _Orm.SelectManyAsync<Person>(null, null, eSelect5);
                Console.WriteLine("| Retrieved: " + selectedList1.Count + " records");
                foreach (Person curr in selectedList1) Console.WriteLine(curr.ToString());
                ...
                selectedList1 = await _Orm.SelectManyAsync<Person>(null, null, eSelect6);
                Console.WriteLine("| Retrieved: " + selectedList1.Count + " records");
                foreach (Person curr in selectedList1) Console.WriteLine(curr.ToString());
                ...
                selectedList1 = await _Orm.SelectManyAsync<Person>(null, null, eSelect7, resultOrder);
                Console.WriteLine("| Retrieved: " + selectedList1.Count + " records");
                foreach (Person curr in selectedList1) Console.WriteLine(curr.ToString());
                ...
                try
                {
                    await _Orm.QueryAsync("SELECT * FROM person (((");
                }
                catch (Exception e)
                {
                ...
                await _Orm.DeleteAsync<Person>(p1);

                for (int i = 0; i < 8; i++) Console.WriteLine("");
                Console.WriteLine("| Deleting p2");
                await _Orm.DeleteByPrimaryKeyAsync<Person>(2);

                for (int i = 0; i < 8; i++) Console.WriteLine("");
                Console.WriteLine("| Deleting records");
                Expr eDelete = new Expr("id", OperatorEnum.GreaterThan, 2);
                await _Orm.DeleteManyAsync<Person>(eDelete);
